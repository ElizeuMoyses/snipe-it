...
final class ContractInput
{
    ...
    public static function validate(array $input, bool $creating, ?Contract $contract = null): array
    {
        ...
        [$data, $invalidMoneyFields] = self::normalize($input);
    ...
    public static function validatePreview(array $input): Contract
    {
        [$data, $invalidMoneyFields] = self::normalize($input);
        $validator = Validator::make(
            $data,
